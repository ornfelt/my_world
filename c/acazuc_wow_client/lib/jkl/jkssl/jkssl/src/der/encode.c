...
static size_t asn1_length(struct asn1_object *object);
static int asn1_encode(struct bio *bio, struct asn1_object *object);
...
static size_t constructed_length(struct asn1_object *object)
{
...
static size_t primitive_length(struct asn1_object *object)
{
	struct asn1_primitive *primitive = (struct asn1_primitive*)object;
	return primitive->size;
}

static size_t universal_length(struct asn1_object *object)
{
	switch (object->type)
	{
		case ASN1_BOOLEAN:
...
static int encode_tag(struct bio *bio, struct asn1_object *object)
{
...
static int encode_length(struct bio *bio, struct asn1_object *object)
{
...
static int encode_constructed(struct bio *bio, struct asn1_object *object)
{
	struct asn1_constructed *constructed = (struct asn1_constructed*)object;
	for (size_t i = 0; i < constructed->objects_count; ++i)
	{
...
static int encode_primitive(struct bio *bio, struct asn1_object *object)
{
	struct asn1_primitive *primitive = (struct asn1_primitive*)object;
	return bio_write(bio, primitive->data, primitive->size) == primitive->size;
}

static int encode_universal(struct bio *bio, struct asn1_object *object)
{
	switch (object->type)
	{
		case ASN1_BOOLEAN:
		...
		case ASN1_UTC_TIME:
		{
			struct asn1_time *utc_time = (struct asn1_time*)object;
			struct tm tm;
#ifdef _WIN32
		...
		case ASN1_GENERALIZED_TIME:
		{
			struct asn1_time *generalized_time = (struct asn1_time*)object;
			struct tm tm;
#ifdef _WIN32
...
int i2d_asn1_object(struct asn1_object *object, uint8_t **dst)
{
	I2D_MEM(asn1_object, struct asn1_object, object);
}

int i2d_asn1_object_fp(FILE *fp, struct asn1_object *object)
{
	I2D_FP(asn1_object, struct asn1_object, object);
}

int i2d_asn1_object_bio(struct bio *bio, struct asn1_object *object)
{
