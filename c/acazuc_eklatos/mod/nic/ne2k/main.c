...
ne2k_r8(struct ne2k *ne2k, uint32_t reg)
{
	return pci_r8(ne2k->pci_map, reg);
}

static inline uint16_t
ne2k_r16(struct ne2k *ne2k, uint32_t reg)
{
	return pci_r16(ne2k->pci_map, reg);
}

static inline uint32_t
ne2k_r32(struct ne2k *ne2k, uint32_t reg)
{
	return pci_r32(ne2k->pci_map, reg);
}

static inline void
ne2k_w8(struct ne2k *ne2k, uint32_t reg, uint8_t val)
{
	pci_w8(ne2k->pci_map, reg, val);
}

static inline void
ne2k_w16(struct ne2k *ne2k, uint32_t reg, uint16_t val)
{
	pci_w16(ne2k->pci_map, reg, val);
}

static inline void
ne2k_w32(struct ne2k *ne2k, uint32_t reg, uint32_t val)
{
	pci_w32(ne2k->pci_map, reg, val);
}

static inline void
ne2k_lock(struct ne2k *ne2k)
{
	mutex_lock(&ne2k->mutex);
}

static inline void
ne2k_unlock(struct ne2k *ne2k)
{
	mutex_unlock(&ne2k->mutex);
}

static inline void
dump_regs(struct ne2k *ne2k)
{
