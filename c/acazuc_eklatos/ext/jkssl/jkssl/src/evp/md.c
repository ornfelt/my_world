...
{ \
	...
	DIGEST_FOREACH(sha256_192);
	DIGEST_FOREACH(sha384);
	DIGEST_FOREACH(sha512);
	DIGEST_FOREACH(sha512_224);
	DIGEST_FOREACH(sha512_256);
	DIGEST_FOREACH(sha3_224);
	DIGEST_FOREACH(sha3_256);
	DIGEST_FOREACH(sha3_384);
	DIGEST_FOREACH(sha3_512);
	DIGEST_FOREACH(shake128);
	DIGEST_FOREACH(shake256);
	DIGEST_FOREACH(sm3);
