...
int
soft_buffer_alloc(struct jkg_ctx *ctx,
...
int
soft_buffer_read(struct jkg_ctx *ctx,
                 struct jkg_buffer *buffer,
                 void *data,
                 uint32_t size,
                 uint32_t offset)
...
int
soft_buffer_write(struct jkg_ctx *ctx,
                  struct jkg_buffer *buffer,
                  const void *data,
                  uint32_t size,
                  uint32_t offset)
...
int
soft_buffer_copy(struct jkg_ctx *ctx,
...
void
soft_buffer_free(struct jkg_ctx *ctx, struct jkg_buffer *buffer)
{
	(void)ctx;
	free(buffer->data);
	free(buffer);
...
int
soft_set_index_buffer(struct jkg_ctx *ctx,
                      struct jkg_buffer *buffer,
...
int
soft_set_vertex_buffers(struct jkg_ctx *ctx,
...
int
soft_set_uniform_blocks(struct jkg_ctx *ctx,
