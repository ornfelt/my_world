...
xcb_shm_query_version(xcb_connection_t *conn)
{
...
xcb_void_cookie_t
xcb_shm_attach(xcb_connection_t *conn,
...
xcb_void_cookie_t
xcb_shm_attach_checked(xcb_connection_t *conn,
                       xcb_shm_seg_t shmseg,
                       uint32_t shmid,
                       uint8_t read_only)
{
...
xcb_void_cookie_t
xcb_shm_detach(xcb_connection_t *conn,
               xcb_shm_seg_t shmseg)
{
	uint16_t length = 2;
...
xcb_void_cookie_t
xcb_shm_detach_checked(xcb_connection_t *conn,
                       xcb_shm_seg_t shmseg)
{
	return checked_request(conn,
		xcb_shm_detach(conn,
...
xcb_void_cookie_t
xcb_shm_put_image(xcb_connection_t *conn,
...
xcb_void_cookie_t
xcb_shm_put_image_checked(xcb_connection_t *conn,
                          xcb_drawable_t drawable,
                          xcb_gcontext_t gc,
                          uint16_t total_width,
                          uint16_t total_height,
...
xcb_shm_get_image(xcb_connection_t *conn,
                  xcb_drawable_t drawable,
                  int16_t x,
                  int16_t y,
                  uint16_t width,
