...
extern const struct wow_dbc_def wow_dbc_declined_word_def[];
extern const struct wow_dbc_def wow_dbc_declined_word_cases_def[];
...
extern const struct wow_dbc_def wow_dbc_language_words_def[];
extern const struct wow_dbc_def wow_dbc_languages_def[];
...
extern const struct wow_dbc_def wow_dbc_startup_strings_def[];
extern const struct wow_dbc_def wow_dbc_string_lookups_def[];
