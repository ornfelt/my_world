...
public:
    ...
    // NOLINTNEXTLINE
    T& get() {
        static_assert(std::is_same<T, version6::CMD_AUTH_LOGON_PROOF_Client>::value, "Invalid type. All possible types have been specialized below.");
    }
...
public:
    ...
    // NOLINTNEXTLINE
    T& get() {
        static_assert(std::is_same<T, version6::CMD_AUTH_LOGON_CHALLENGE_Server>::value, "Invalid type. All possible types have been specialized below.");
    }
